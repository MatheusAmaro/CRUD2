...
if(empty($name_err) && empty($address_err) && empty($salary_err)){
   ...
   $sql = "INSERT INTO employees (nome, endereco, salario) VALUES (:nome,:endereco, :salario)";
   if($stmt = $pdo->prepare($sql)){
      ...
      / Attempt to execute the prepared statement
       if($stmt->execute()){
         // Registros criados com sucesso. Redirect to landing page header("location: index.php");
      exit();
      } else {
...
<textarea name="endereco" class="form-control"><?phpecho $endereco; ?></textarea><span class="help-block"><?php echo$address_err;?></span>
</div>
